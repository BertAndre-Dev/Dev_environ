...
export default function EnergyProviderEstateForm({
  initialData = null,
  onSubmit,
}: Readonly<Props>) {
  ...
  const modulesLoading = useSelector(selectEnergyProviderModulesLoading);
  const modulesError = useSelector(selectEnergyProviderModulesError);
