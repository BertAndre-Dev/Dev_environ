...
export interface ViewRevenueHeadModalProps {
  open: boolean;
  loading: boolean;
  item: RevenueHead | null;
  onOpenChange: (open: boolean) => void;
}

export function ViewRevenueHeadModal({
  open,
  loading,
  item,
  onOpenChange,
}: Readonly<ViewRevenueHeadModalProps>) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Revenue Head Details</DialogTitle>
        </DialogHeader>
