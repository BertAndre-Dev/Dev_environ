...
export default function FAQSection() {
  ...
  return (
    <section id="faq" className="scroll-mt-28 bg-white py-8 lg:py-16 my-16 lg:my-24">
      <div className="container mx-auto px-6 md:px-8 lg:px-10 xl:px-20 max-w-[1320px] xl:max-w-[1440px]">
        <div className="rounded-3xl bg-[#F8F8F8] px-6 py-10 sm:px-8 sm:py-12 lg:px-12 lg:py-16 xl:px-16">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] lg:gap-14 xl:gap-20 items-start">
            {/* Left: heading + CTA */}
