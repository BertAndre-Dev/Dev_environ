...
export const createRevenueEntries = createAsyncThunk(
  "admin-revenue-entry/createRevenueEntries",
  async (
    payload: {
      entries: Array<{
        headId: string;
...
export const fetchRevenueEntries = createAsyncThunk(
  "admin-revenue-entry/fetchRevenueEntries",
  async (
    {
      headId,
      page = 1,
...
export const fetchRevenueEntryById = createAsyncThunk(
  "admin-revenue-entry/fetchRevenueEntryById",
...
export const updateRevenueEntry = createAsyncThunk(
  "admin-revenue-entry/updateRevenueEntry",
  async (
    {
      id,
      headId,
...
export const deleteRevenueEntry = createAsyncThunk(
  "admin-revenue-entry/deleteRevenueEntry",
  async (id: string, { rejectWithValue }) => {
    try {
