...
} from "./staff-asset-maintenance";

type AsyncStatus = "idle" | "isLoading" | "succeeded" | "failed";

export interface StaffAssetMaintenanceState {
...
const initialState: StaffAssetMaintenanceState = {
  records: [],
  pagination: null,
...
const staffAssetMaintenanceSlice = createSlice({
  name: "staffAssetMaintenance",
  initialState,
  reducers: {
    clearStaffAssetMaintenanceError: (state) => {
      state.error = null;
    },
    clearStaffAssetMaintenanceComments: (state) => {
...
export const {
  clearStaffAssetMaintenanceError,
  clearStaffAssetMaintenanceComments,
} = staffAssetMaintenanceSlice.actions;
export default staffAssetMaintenanceSlice.reducer;

export const selectStaffAssetMaintenance = (state: RootState) =>
  (state.staffAssetMaintenance as StaffAssetMaintenanceState | undefined) ??
  initialState;
