...
export const selectExpenseEntries = (state: RootState) =>
  (state.staffExpenseEntry as ExpenseEntryState)?.items ?? [];
export const selectExpenseEntriesLoading = (state: RootState) =>
  isPending((state.staffExpenseEntry as ExpenseEntryState)?.listState);
export const selectExpenseEntriesError = (state: RootState) =>
  (state.staffExpenseEntry as ExpenseEntryState)?.error ?? null;
export const selectExpenseEntriesPagination = (state: RootState) =>
  (state.staffExpenseEntry as ExpenseEntryState)?.pagination ?? null;
export const selectExpenseEntrySelected = (state: RootState) =>
  (state.staffExpenseEntry as ExpenseEntryState)?.selected ?? null;
