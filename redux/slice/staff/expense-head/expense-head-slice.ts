...
export const selectExpenseHeads = (state: RootState) =>
  (state.staffExpenseHead as ExpenseHeadState)?.items ?? [];
export const selectExpenseHeadsLoading = (state: RootState) =>
  isPending((state.staffExpenseHead as ExpenseHeadState)?.listState);
export const selectExpenseHeadsError = (state: RootState) =>
  (state.staffExpenseHead as ExpenseHeadState)?.error ?? null;
export const selectExpenseHeadsPagination = (state: RootState) =>
  (state.staffExpenseHead as ExpenseHeadState)?.pagination ?? null;
