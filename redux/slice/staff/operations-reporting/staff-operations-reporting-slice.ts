...
} from "./staff-operations-reporting";

type AsyncStatus = "idle" | "isLoading" | "succeeded" | "failed";

export interface StaffOperationsReportingState {
...
const initialState: StaffOperationsReportingState = {
  types: [],
...
const staffOperationsReportingSlice = createSlice({
  name: "staffOperationsReporting",
  initialState,
  reducers: {
    clearStaffOperationsReportingError: (state) => {
      state.error = null;
    },
...
export const {
  clearStaffOperationsReportingError,
  setSelectedOperationsReportingType,
  setSelectedOperationsReportingField,
} = staffOperationsReportingSlice.actions;

export default staffOperationsReportingSlice.reducer;

export const selectStaffOperationsReporting = (state: RootState) =>
  (state.staffOperationsReporting as StaffOperationsReportingState | undefined) ??
  initialState;
