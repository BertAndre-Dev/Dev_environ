...
export const selectRevenueHeads = (state: RootState) =>
  (state.staffRevenueHead as RevenueHeadState)?.items ?? [];
export const selectRevenueHeadsLoading = (state: RootState) =>
  isPending((state.staffRevenueHead as RevenueHeadState)?.listState);
export const selectRevenueHeadsError = (state: RootState) =>
  (state.staffRevenueHead as RevenueHeadState)?.error ?? null;
export const selectRevenueHeadsPagination = (state: RootState) =>
  (state.staffRevenueHead as RevenueHeadState)?.pagination ?? null;
